...
var Charts = function Charts(opts, _components) {
    ...
    this.context = _components ? wx.createCanvasContext(opts.canvasId, _components) : wx.createCanvasContext(opts.canvasId);
